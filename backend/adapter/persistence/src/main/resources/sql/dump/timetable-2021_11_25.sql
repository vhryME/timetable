...
COPY timetable.users (id, username, email, password, role_id, updated_at, updated_by) FROM stdin;
1	string	string@mail.ru	string	1	2021-11-25 17:38:47.086809	postgres
2	string	string@mail.ru	string	2	2021-11-25 17:38:47.086809	postgres
\.
