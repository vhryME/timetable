            ...
            <div className={"hero--main-container"}>
                ...
                <Modal title={"Skill"}
                    ...
                    <div className={"hero--modal-container"}>
                        <div className={"hero--icon-upload"}>
                ...
                {!this.props.readonly
                    ? <div className={"hero--footer-buttons"}>
                        <Button shape={"circle"} className={"hero--button"}
                                onClick={() => this.props.history.push("/heroes")}>
                            <LeftOutlined/>
                        </Button>
                        <Button shape={"circle"} type={"primary"} form={this.mainFormId} className={"hero--button"}
                                htmlType={"submit"}>
                            <SaveOutlined/>
                        </Button>
                    </div>
